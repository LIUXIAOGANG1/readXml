 ...
 * @author Pere Bonet
 */
public class SGSwingToolTipListener 
   ...
   public boolean addNodeToolTipItems(Node theNode, JComponent theJComponent,
      ...
      String marking = "";
      if (theNode instanceof SGNode) {
         marking = ((SGNode)theNode).getPlaceNo(); // changed to show the placeNo
      }
      // the pathset of the node
      String pathset = "";
      if(theNode instanceof SGNode){
    	  pathset = ((SGNode)theNode).getPathsetString();
      }
      String timeset = "";
      if(theNode instanceof SGNode){
    	  timeset = ((SGNode)theNode).getTimesetString();
      }
      ...
      JEditorPane editor = new JEditorPane("text/html", "<font size=3><b>" +
              ...
              "</font><hr size=1><font size=3><b>Corresponding to : </b>" + marking +
              "</font><hr size=1><font size=3><b>Pathset: </b>" + pathset +
              "</font><hr size=1><font size=3><b>Timeset: </b>" + timeset +
              "</font>");
