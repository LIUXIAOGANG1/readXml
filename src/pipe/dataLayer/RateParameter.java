...
public class RateParameter 
   ...
   //金龙修改
//   public class StarttimeParameter 
//   extends Parameter {
//
//// the value of the parameter
//private Double value;    
...
//
// 
//public StarttimeParameter(String _name, Double _value, int x, int y){
// super (x, y);
// name = _name;
// value = _value;
// transitionsHashSet = new HashSet();
...
//金龙修改结束
   ...
   public Parameter paste2(double x, double y, boolean fromAnotherView) {
	      return new RateParameter(name, value,
	                               (int)this.getX() + Grid.getModifiedX(x),
	                               (int)this.getY() + Grid.getModifiedY(y));            
	   }
