...
//PetriNet Object Type Definitions
   ...
   //金龙 
   //public static final int INTERVALTRANS   = 127;
   //结束
   ...
   // du: 用于MRG Analysis菜单
   public static final int MT  =121;
   public static final int COMPOSE  =122;
   public static final int DECOMPOSE =123;
   public static final int CONSTRUCT =124;
   public static final int ANALYZE =125;
   public static final int ANALYZE1 =126;
   public static final int LIMITFRAME =127;
   public static final int LIMITACTION =128;
