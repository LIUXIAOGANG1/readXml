...
import jpowergraph.SGSwingToolTipListener;
...
public class SGraphFrame 
   ...
   public void constructGraphFrame(DefaultGraph graph, String markingLegend) {
      ...
      jGraphPane.setNodePainter(SGNode.class, SGNode.getShapeNodePainter());
      jGraphPane.setDefaultNodePainter(SGNode.getShapeNodePainter());
      /*
      ...
      */
      ...
      jGraphPane.setPopupDisplayer(new SwingPopupDisplayer(new SGSwingToolTipListener(), 
      ...
      if (markingLegend != "" && markingLegend != null) {
         markingLegend = "Transition firing sequence is " + markingLegend;
      }
      
      JTextArea legend = new JTextArea( markingLegend +
              "\nHover mouse over nodes to view node information");
