...
public class Matrices 
   ...
   private String renderMatrix(DataLayer data,int[][] matrix) {
      ...
      for (int i = 0; i < matrix[0].length;i++) {
         ...
         //**** explained by Bingxue :
         //****i: meaning the adding sequence number-1 and may or may not be the name or id of the place or transition
         // in dataLayer they maintain an arraylist called transitionArray or placeArray and both are ordered by Adding Sequence.
      }
