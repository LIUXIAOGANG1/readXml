...
public class BasicPTabbedPaneReverseIconUI extends BasicTabbedPaneUI implements CloseIconUI  {

    private static final ImageIcon close = new ImageIcon(BasicPTabbedPaneReverseIconUI.class.getResource("close.gif"));
    private static final ImageIcon closehighlighted = new ImageIcon(BasicPTabbedPaneReverseIconUI.class.getResource("closehighlighted.gif"));
