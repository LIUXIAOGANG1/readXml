...
public class MetalPTabbedPaneReverseIconUI extends MetalTabbedPaneUI implements CloseIconUI {

    private static final ImageIcon close = new ImageIcon(MetalPTabbedPaneReverseIconUI.class.getResource("close.gif"));
    private static final ImageIcon closehighlighted = new ImageIcon(MetalPTabbedPaneReverseIconUI.class.getResource("closehighlighted.gif"));
